<h2><a href="https://www.geeksforgeeks.org/problems/binary-representation5003/1?page=3&category=Bit%20Magic&sortBy=submissions">Binary representation</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Write a program to print Binary representation of a given number N.</span></p>
